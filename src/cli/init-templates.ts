...
const BASIC_USER_ROUTE = `import { HttpError, type Context } from 'anvil';
...
const MCP_USER_ROUTE = `import { HttpError, type Context } from 'anvil';
import { z } from 'zod';
...
const AGENT_ROUTE = `import { defineAgent } from 'anvil/agent';
